    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mbse_type', models.CharField(choices=[('0', '未激活'), ('1', '普通会员'), ('2', '高级会员'), ('3', '理事会员')], default='0', max_length=16, verbose_name='用户类型')),
                ...
                ('mbse_exp', models.CharField(blank=True, max_length=128, null=True, verbose_name='有效期')),
                ('mbr_name', models.CharField(blank=True, default='空', max_length=128, null=True, verbose_name='姓名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mbse_code', models.CharField(blank=True, max_length=128, null=True, verbose_name='会员编号')),
                ('mbse_exp', models.CharField(blank=True, max_length=128, null=True, verbose_name='有效期')),
                ('inc_name', models.CharField(blank=True, max_length=128, null=True, verbose_name='单位全称')),
                ...
                ('inc_info', models.TextField(blank=True, max_length=128, null=True, verbose_name='备注')),
            ],
            options={
                'verbose_name': '理事单位会员',
